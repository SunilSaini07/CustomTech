     ...
     <div className="min-h-screen bg-white font-inter text-gray-800 overflow-hidden relative">
      ...
      <section className="relative pt-40 pb-36 overflow-hidden">
        ...
        <motion.div
          ...
          animate={{ borderRadius: ["62% 38% 70% 30% / 39% 68% 32% 61%", "30% 70% 40% 60% / 55% 35% 65% 45%","62% 38% 70% 30% / 39% 68% 32% 61%"] }}
        ...
        >
          ...
          >
            ...
            <br />
            Move the World {gradientText("Forward")}
          </motion.h1>
      ...
      <section className="py-28 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-gray-600 text-lg mb-14 max-w-3xl mx-auto">
            Principles that define how we think, work, and innovate.
          </p>

          <div className="grid md:grid-cols-3 gap-10">
            {[
              { icon: <FaRocket className="text-4xl text-cyan-500"/>, title: "Innovation", desc: "Fresh thinking, smarter solutions, continuous evolution." },
              { icon: <FaHeartbeat className="text-4xl text-purple-500"/>, title: "Human Connection", desc: "Design built around emotion, empathy, and clarity." },
              { icon: <FaGlobeAmericas className="text-4xl text-blue-500"/>, title: "Global Reach", desc: "Products that scale and perform in every market." },
            ].map((value, index) => (
              <motion.div
                key={index}
              ...
              >
                {/* animated icon */}
                <motion.div variants={iconFloat} initial="initial" animate="animate" className="mb-5 inline-block">
                  {value.icon}
                </motion.div>
